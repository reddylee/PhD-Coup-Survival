...
\toprule
\textbf{Characteristic} & \textbf{Event N} & \textbf{log(HR)}\textsuperscript{\textit{1,2}} & \textbf{HR}\textsuperscript{\textit{2}} & \textbf{95\% CI}\textsuperscript{\textit{2}} & \textbf{p-value} \\ 
\midrule\addlinespace[2.5pt]
Leader type & 103 &  &  &  &  \\ 
    Overstay leaders &  & 0.00 & 1.00 & — &  \\ 
    Coup-entry leaders &  & 0.91*** & 2.49 & 1.53, 4.07 & \textbf{<0.001} \\ 
GDP growth trend & 103 & 0.00 & 1.00 & 1.00, 1.00 & 0.4 \\ 
Log of GDP per capita & 103 & -0.32* & 0.73 & 0.57, 0.93 & \textbf{0.011} \\ 
Log of population & 103 & 0.22 & 1.25 & 0.95, 1.64 & 0.11 \\ 
Polity5 score & 103 & 0.00 & 1.00 & 0.96, 1.05 & 0.9 \\ 
Political stability & 103 & 0.02 & 1.02 & 0.93, 1.13 & 0.6 \\ 
Age of leader & 103 & 0.01 & 1.01 & 0.99, 1.03 & 0.4 \\ 
No. Obs. &  &  & 219 &  &  \\ 
Log-likelihood &  &  & -447 &  &  \\ 
AIC &  &  & 908 &  &  \\ 
BIC &  &  & 926 &  &  \\ 
...
\textsuperscript{\textit{2}}HR = Hazard Ratio, CI = Confidence Interval\\
\end{minipage}
...
cox proportional hazards model is presented in Table~\ref{tbl-cox}. The
Table~\ref{tbl-cox} underscores the significance of leader type and GDP
per capita in influencing the hazard ratios associated with leaders'
...
The Figure~\ref{fig-coxHR} illustrates the hazard ratios and 95\%
confidence intervals for the variables in the Cox model. The hazard
ratio for coup-entry leaders is 2.49, signifying that coup-entry leaders
are 1.49 times more likely to face ousting compared to overstaying
leaders, all else being equal. Additionally, the hazard ratio associated
with the logarithm of GDP per capita is 0.73, suggesting that a 1\%
increase in GDP per capita is correlated with a 27\% reduction in the
hazard of being ousted. It is noteworthy that the remaining variables
...
\caption{\label{fig-coxSurv}Cox proportional hazards model for survival
time of leaders}

\end{figure}%

The Figure~\ref{fig-coxSurv} illustrates the survival curves for
overstaying leaders and coup-entry leaders. The survival probability of
overstaying leaders is significantly higher than that of coup-entry
leaders, as the survival probability of overstaying leaders is 0.85 at
5,000 days, while that of coup-entry leaders is 0.65 at the same time
point. This finding is consistent with the results of the Cox model,
which indicates that overstaying leaders are more likely to experience
extended regime survival compared to leaders who come to power through
coups.
