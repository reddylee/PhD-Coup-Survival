...
Here, I employ Cox proportional hazards models to assess the likelihood
of leaders being removed from office, essentially examining the hazards
associated with leadership tenure termination.
...
cox proportional hazards model is presented in Table~\ref{tbl-cox}.

\begin{table}[htbp]

\caption{\label{tbl-cox}Cox proportional hazards model for survival time
of leaders}

\centering{

\centering
\begin{tabular}{>{\raggedright\arraybackslash}p{4cm}>{\raggedright\arraybackslash}p{2cm}>{\raggedright\arraybackslash}p{2cm}>{\raggedright\arraybackslash}p{1.5cm}>{\raggedright\arraybackslash}p{2.5cm}>{\raggedright\arraybackslash}p{1.5cm}}
\toprule
\textbf{Characteristic} & \textbf{Event N} & \textbf{log(HR)} & \textbf{HR} & \textbf{95\% CI} & \textbf{p-value}\\
\midrule
\cellcolor{gray!6}{Leader type} & \cellcolor{gray!6}{103} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{}\\
\addlinespace
\hspace{1em}Overstay leaders &  & 0.00 & 1.00 & — & \\
\addlinespace
\cellcolor{gray!6}{\hspace{1em}Coup-entry leaders} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{0.91***} & \cellcolor{gray!6}{2.49} & \cellcolor{gray!6}{1.53, 4.07} & \cellcolor{gray!6}{\textbf{<0.001}}\\
\addlinespace
GDP growth trend & 103 & 0.00 & 1.00 & 1.00, 1.00 & 0.4\\
\addlinespace
\cellcolor{gray!6}{Log of GDP per capita} & \cellcolor{gray!6}{103} & \cellcolor{gray!6}{-0.32*} & \cellcolor{gray!6}{0.73} & \cellcolor{gray!6}{0.57, 0.93} & \cellcolor{gray!6}{\textbf{0.011}}\\
\addlinespace
Log of population & 103 & 0.22 & 1.25 & 0.95, 1.64 & 0.11\\
\addlinespace
\cellcolor{gray!6}{Polity5 score} & \cellcolor{gray!6}{103} & \cellcolor{gray!6}{0.00} & \cellcolor{gray!6}{1.00} & \cellcolor{gray!6}{0.96, 1.05} & \cellcolor{gray!6}{0.9}\\
\addlinespace
Political stability & 103 & 0.02 & 1.02 & 0.93, 1.13 & 0.6\\
\addlinespace
\cellcolor{gray!6}{Age of leader} & \cellcolor{gray!6}{103} & \cellcolor{gray!6}{0.01} & \cellcolor{gray!6}{1.01} & \cellcolor{gray!6}{0.99, 1.03} & \cellcolor{gray!6}{0.4}\\
\addlinespace
\midrule
No. Obs. &  &  & 219 &  & \\
\addlinespace
\cellcolor{gray!6}{Log-likelihood} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{-447} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{}\\
\addlinespace
AIC &  &  & 908 &  & \\
\addlinespace
\cellcolor{gray!6}{BIC} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{926} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{}\\
\bottomrule
\multicolumn{6}{l}{\rule{0pt}{1em}\textsuperscript{1} \textit{p<0.05; \textbf{p<0.01; }}p<0.001}\\
\multicolumn{6}{l}{\rule{0pt}{1em}\textsuperscript{2} HR = Hazard Ratio, CI = Confidence Interval}\\
\end{tabular}
...
groupCoup-entry leaders & 2.492642 & 0.2505630981 & 3.6451630 & 0.0002672224 & 1.5253878 & 4.0732369 \\ 
GDP\_growth\_trend & 1.000689 & 0.0008869125 & 0.7765857 & 0.4374032156 & 0.9989510 & 1.0024300 \\ 
GDP\_pc\_log & 0.725924 & 0.1258370362 & -2.5454344 & 0.0109141854 & 0.5672552 & 0.9289746 \\ 
pop\_log & 1.245529 & 0.1391871694 & 1.5774454 & 0.1146930805 & 0.9481508 & 1.6361763 \\ 
polity5 & 1.004677 & 0.0247493178 & 0.1885380 & 0.8504548914 & 0.9571056 & 1.0546131 \\ 
polstab & 1.024551 & 0.0502471244 & 0.4827113 & 0.6293007415 & 0.9284603 & 1.1305875 \\ 
age & 1.008426 & 0.0103036922 & 0.8143645 & 0.4154361610 & 0.9882655 & 1.0289983 \\ 
\bottomrule
\end{longtable*}

\includegraphics{survival_after_coups_jasa_files/figure-pdf/unnamed-chunk-7-1.pdf}

The Table~\ref{tbl-cox} underscores the significance of leader type and
GDP per capita in influencing the hazard ratios associated with leaders'
ousting. Specifically, the hazard ratio for coup-entry leaders is 2.49,
signifying that coup-entry leaders are 1.49 times more likely to face
ousting compared to overstaying leaders, all else being equal.
...
correlated with a 27\% reduction in the hazard of being ousted. It is
noteworthy that the remaining variables did not exhibit statistical
