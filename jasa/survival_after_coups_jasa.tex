...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, interior hidden, enhanced, boxrule=0pt, breakable, sharp corners, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
...
Previous research exploring the longevity of political leaders has
revealed two major areas of emphasis. Primarily, scholars have
predominantly focused on general frameworks encompassing all regime
types or various autocracies, with fewer delving into specific leader
profiles. Secondly, existing studies have primarily centered around
analyzing the likelihood of unforeseen leader exits using country-year
data, creating a gap in discussions concerning the duration of
leadership tenures based on comprehensive duration data.

Due to these significant gaps, this paper aims to conduct a comparative
analysis between two distinct categories of political leaders: those who
rise to power through coups and those who exceed their designated term
...
tenures of survival between leaders who entered through coups and those
who engaged in overstaying (self-coup) maneuvers.

However, while existing research extensively discusses factors leading
to coups or overstays, there is a need for more attention to what
happens after these irregular ascents. Specifically, how do leaders'
entry manners affect their subsequent tenures? This study proposes that
the means by which political leaders acquire power significantly impacts
their duration of leadership. Utilizing a survival model, empirical
evidence suggests that leaders who exceed their term limits generally
enjoy longer tenures compared to those who enter through coups. Unlike
overstaying leaders, coup-entry leaders grapple with more significant
challenges related to legitimacy, uncertainty, instability, and
power-sharing, potentially curtailing their survival duration.

This study could make dual contributions. Firstly, it underscores that
the duration of survival and unforeseen exits isn't solely determined by
leaders' actions post-assuming power but is inherently influenced by
their means of ascension to power. Secondly, it provides empirical
measurements for comparing the tenure duration of two irregularly
ascended leaders, shedding light on their respective impacts on
