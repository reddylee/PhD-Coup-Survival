...
abstract: |
 This paper delves into the durations of political leaders' tenures, examining two distinct categories: coup-entry leaders and those who exceed their designated term limits. It argues that the longevity of political leadership is shaped not solely by their governance or policies but also by the methods through which they assume power. Through the utilization of a survival model, this study demonstrates that leaders who enter through coups tend to have shorter tenures compared to those who extend their stay beyond constitutional limits. The research aims to uncover the underlying rationale behind these divergent durations, shedding light on the factors contributing to such differences in survival within political leadership.
...
, as evidenced by notable contributions such as those by @clinton1975politics and @buenodemesquita2003.
...
An illustrative example can be found in the United States, where presidents may serve up to eight years if they secure a second term, even in cases of sub-optimal performance.
...
Given the distinctive nature of political leader survival in different regimes, scholars have increasingly focused on the unexpected tenures, namely those leaders who do not complete their original terms or those who overstay their terms.
This shift in focus stems from the fact that some leaders are toppled by coups, uprisings, rebellions, civil wars, or revolutions, while others successfully survive lawful or unlawful challenges.
Previous research on the longevity of political leaders predominantly centers on two primary dimensions.
The first dimension encompasses the contextual conditions and resources available to leaders (**objective conditions**), including factors such as their personal competence [@yu2016], the stability of their society [@arriola2009], economic performance [@palmer1999, @williams2011], access to natural resources [@smith2004; @quirozflores2012], and external support networks [@licht2009; @wright2008, @thyne2017].
The second dimension delves into the strategies employed by leaders in enacting their political and economic policies (**subjective actions**) [@gandhi2007; @morrison2009], as well as their responses to challenges and dissent within their regimes [@escribà-folch2013; @davenport2021].
...
The analysis of unregular-entry or overstaying leaders' tenures holds particular significance for two reasons.
...
Expanding on the discourse surrounding coup-entry leaders and overstaying leaders, this paper delves into the variations in survival duration between these two types leaders, while also shedding light on the underlying factors contributing to these distinctions.
...
Many scholars, like @buenodemesquita2003 set out in their ambitious work, try to provide a comprehensive explanation for the logic of political leadership survival within a universal framework.
...
Moreover, the concept of dividing the residents into different coalitions or groups may not be as relevant in democracies.
...
For instance, a candidate who advocates lower taxe wins the election.
...
Consequently, it becomes challenging to argue that supporting groups of incumbents inherently gain a significant advantage over the opponent groups in democratic systems.
...
As a result of the absence of transparent and fair conventional procedures for power transitions, leaders in autocratic regimes are more vulnerable to being deposed through coups or other unconventional means than democratic ones.
