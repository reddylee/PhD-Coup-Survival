...
Autocratic rulers grapple with a complex predicament known as the "Guardianship dilemma" when handling powerful elites.
Their primary need is for loyal supporters.
Yet, they face a paradoxical requirement regarding these supporters: they require them to possess enough competence to defend against both internal and external adversaries, but they fear that excessive competence might lead these supporters to aspire to replace the rulers themselves [@wintrobe2012; @mcmahon2015; @geddes2018].
