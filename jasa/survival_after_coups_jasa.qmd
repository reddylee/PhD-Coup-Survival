...
Previous research exploring the longevity of political leaders has revealed two major areas of emphasis.
Primarily, scholars have predominantly focused on general frameworks encompassing all regime types or various autocracies, with fewer delving into specific leader profiles.
Secondly, existing studies have primarily centered around analyzing the likelihood of unforeseen leader exits using country-year data, creating a gap in discussions concerning the duration of leadership tenures based on comprehensive duration data.

Due to these significant gaps, this paper aims to conduct a comparative analysis between two distinct categories of political leaders: those who rise to power through coups and those who exceed their designated term limits.
...
Hence, it becomes both relevant and enlightening to delve into and compare the tenures of survival between leaders who entered through coups and those who engaged in overstaying (self-coup) maneuvers.

However, while existing research extensively discusses factors leading to coups or overstays, there is a need for more attention to what happens after these irregular ascents.
Specifically, how do leaders' entry manners affect their subsequent tenures?
This study proposes that the means by which political leaders acquire power significantly impacts their duration of leadership.
Utilizing a survival model, empirical evidence suggests that leaders who exceed their term limits generally enjoy longer tenures compared to those who enter through coups.
Unlike overstaying leaders, coup-entry leaders grapple with more significant challenges related to legitimacy, uncertainty, instability, and power-sharing, potentially curtailing their survival duration.

This study could make dual contributions.
Firstly, it underscores that the duration of survival and unforeseen exits isn't solely determined by leaders' actions post-assuming power but is inherently influenced by their means of ascension to power.
Secondly, it provides empirical measurements for comparing the tenure duration of two irregularly ascended leaders, shedding light on their respective impacts on leadership longevity.
...
However, it's crucial to recognize that the dynamics of leadership survival differ significantly across various regime types.

Within democratic systems, distinctions arise between parliamentary and presidential regimes.
For example, in parliamentary countries like the UK and Japan, political parties may retain power for extended periods despite frequent changes in prime ministership.
An instance of this occurred in the United Kingdom in 2022, witnessing three different prime ministers while the Conservative Party remained in power.
Conversely, in presidential countries such as the United States, leaders serve fixed terms, resulting in more regular and predictable power transitions.
The spectrum of autocratic regimes is even more diverse, each characterized by distinct features, including civilian autocracy, personnel autocracy, military regimes, party dominance, and monarchies.
Some regimes strictly adhere to periodic power transitions, as seen in autocratic Mexico from 1919 to 2000, where each president served a fixed six-year term without facing overthrows or overstays [@a"perfe2021]. Additionally, there are instances where dictators rule indefinitely, passing power to their sons, such as in Syria and North Korea, or to brothers, as observed in Cuba. However, there are also numerous cases where rulers are ousted unexpectedly.

Furthermore, the division of residents into different coalitions or groups may not hold as much relevance in democracies when compared to autocracies.
...
For instance, if a candidate advocating for lower taxes wins an election, it doesn't lead to lower taxes for the candidate's supporters and higher taxes for their opponents; both groups encounter identical tax levels.
...
Moreover, the rules governing power transitions differ drastically between democracies and autocracies.
